...
export default function Navbar() {
    ...
    return (
        <div className='navbar  text-white p-4' style={{ fontFamily: "'Poppins', sans-serif" }}>
            <nav className='md:flex flex-nowrap items-center justify-between px-6'>
                ...
                <div className="section-2">
                    <ul className={` ${menu ? '' : 'hidden'} md:flex flex-nowrap items-center gap-4 mt-3 md:mt-0`}>
                        ...
                        <li><Link className='flex flex-nowrap items-center gap-1 uppercase text-sm hover:text-[#47fffc] transition-all font-medium p-3 md:p-0'><BiLogoGraphql /> Tech Stack</Link></li>
                        <li><Link className='flex flex-nowrap items-center gap-1 uppercase text-sm hover:text-[#47fffc] transition-all font-medium p-3 md:p-0'><LuPackageOpen /> Projects</Link></li>
                        ...
                        <li><Link className='flex md:hidden flex-nowrap items-center gap-1 uppercase text-sm hover:text-[#47fffc] transition-all font-medium p-3 md:p-0'><FaHeadphonesAlt /> Contact me</Link></li>
                    </ul>
                </div>
            </nav>
        </div>
