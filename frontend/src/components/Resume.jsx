                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="about p-7 sm:p-10">
                        ...
                        <p className='mt-5 mb-2 text-md font-semibold text-slate-500'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem eaque ipsum rem consequuntur deserunt ex! Labore.
                        </p>
                        <p className='mt-5 mb-2 text-md font-semibold text-slate-500'>
                            molestias architecto, dolorem quisquam voluptatibus nisi dignissimos qui quia, adipisci a quos? Fuga quis quaerat, repellendus quia, incidunt illum fugiat nemo possimus reprehenderit iste doloribus cupiditate, a excepturi repellat. Eveniet optio doloribus maxime delectus, nemo ad voluptate labore, ipsam hic at iure, totam laudantium.
                        </p>
                        <h1 className='mt-5 mb-2 text-md font-bold text-slate-900'>Connect With Me.</h1>
                        <div className="flex flex-nowrap items-center gap-3">
                            <button type="button" className='px-8 py-3 text-white bg-gradient-to-r from-cyan-500 to-blue-500 font-semibold text-sm rounded-md flex flex-nowrap items-center gap-1' >Linkedin <FaLinkedin className='text-lg' /></button>
                            <button type="button" className='px-8 py-3 text-white bg-gradient-to-r from-red-500 to-pink-500 font-semibold text-sm rounded-md flex flex-nowrap items-center gap-1' >Email <MdMarkEmailUnread className='text-lg' /></button>
                        </div>
                    </div>
