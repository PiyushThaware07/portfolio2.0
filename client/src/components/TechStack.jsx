                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-6">
                    ...
                    <div className="card h-full card border-2 hover:border-dotted border-spacing-2 border-white hover:border-black rounded-lg ">
                        <div className="h-full border-2 border-black hover:bg-blue-100 rounded-lg hover:translate-x-[-5px] hover:translate-y-[-5px] transition-all   px-5 py-3">
                            ...
                            <div className="mb-3 md:mb-5 flex flex-wrap gap-2">
                                <span><button className='flex flex-nowrap items-center gap-1 bg-blue-500 p-2 text-white rounded-md' ><FaPython /> <h1 className='text-sm font-semibold'>Python</h1> </button></span>
                                <span><button className='flex flex-nowrap items-center gap-1 bg-emerald-600 p-2 text-white rounded-md' ><SiDjango className='text-lg' /> <h1 className='text-sm font-semibold'>Django</h1> </button></span>
